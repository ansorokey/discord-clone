...
export function ChatItem({
    ...
    // add event listener to close editing input
    useEffect(() => {
    ...
    // this is for real time updates, so when a new message is
    // recieved, the currently edited message does not show up again
    useEffect(() => {
        form.reset({
            content: content
        })
                ...
                <div className="flex flex-col w-full">
                    ...
                    { isPDF && (
                        <div
                            ...
                            mt-2 rounded-md bg-background/10"
                        >
                            <FileIcon
