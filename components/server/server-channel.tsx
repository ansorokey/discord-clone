...
export function ServerChannel({
    ...
    // this following function was written because the onCLick func above
    // would have overwritten the default onClick functions
    // basically just a differently named function for namespace sake
    ...
    return (
        ...
        >
            ...
            {/* any channel but general and mod permissions can edit or delete channel */}
